...
vlog -work work ..\..\..\clock_gen.v
vlog -work work ..\..\example_design\clock_gen_exdes.v
vlog -work work ..\clock_gen_tb.v

REM run the simulation
vsim -c -t ps -voptargs="+acc" -L secureip -L unisims_ver work.clock_gen_tb work.glbl
